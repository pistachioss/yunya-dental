...
public class PatientMemberRelation {
    ...
    /**
     * 关联类型 0：主副卡关联（可用会员卡优惠权益、礼包），1：充值关联（可用会员卡余额）
     */
     ...
     * 获取副卡会员ID
     *
     * @return secondary_card_id - 副卡会员ID
     */
    ...
    /**
     * 获取关联类型 0：主副卡关联（可用会员卡优惠权益、礼包），1：充值关联（可用会员卡余额）
     *
     * @return bind_type - 关联类型 0：主副卡关联（可用会员卡优惠权益、礼包），1：充值关联（可用会员卡余额）
     */
    ...
    /**
     * 设置关联类型 0：主副卡关联（可用会员卡优惠权益、礼包），1：充值关联（可用会员卡余额）
     *
     * @param bindType 关联类型 0：主副卡关联（可用会员卡优惠权益、礼包），1：充值关联（可用会员卡余额）
     */
