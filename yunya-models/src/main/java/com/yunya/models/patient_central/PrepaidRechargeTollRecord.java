...
@Table(name = "prepaid_recharge_toll_record")
public class PrepaidRechargeTollRecord {
    /**
     * 主键
     */
    @Id
     ...
     * 获取充值记录ID
     *
     * @return recharge_record_id - 充值记录ID
     */
