...
@Table(name = "patient_kin_relation")
public class PatientKinRelation {
    /**
     * 主键
     */
    @Id
     ...
     * 获取关联患者ID
     *
     * @return linked_patient_id - 关联患者ID
     */
     ...
     * 获取亲属关系字典类型ID 字典管理
     *
     * @return kinship_id - 亲属关系字典类型ID 字典管理
     */
     ...
     * 设置亲属关系字典类型ID 字典管理
     *
     * @param kinshipId 亲属关系字典类型ID 字典管理
     */
