...
@Table(name = "clinic_account_item")
public class ClinicAccountItem {
    /**
     * 主键ID
     */
    @Id
     ...
     * 获取公司端对应支付方式分类表的ID
     *
     * @return account_item_id - 公司端对应支付方式分类表的ID
     */
     ...
     * 设置公司端对应支付方式分类表的ID
     *
     * @param accountItemId 公司端对应支付方式分类表的ID
     */
