...
public class BaseEmployeeController {
    ...
    public RestDataResult saveBaseEmployee(@Valid @RequestBody BaseEmployeeCreateReq createReq) {
    ...
    public RestDataResult modifyEmployee(@PathVariable("employeeId") Integer employeeId,
    ...
    public RestDataResult deleteBaseEmployee(@PathVariable("employeeId") Integer employeeId) {
