...
//        appointmentBaseForm.setOrgId(35);
        ...
        employeeScheduleQueryForm.setStartDate("2020-07-13");
        employeeScheduleQueryForm.setClinicId(35);
        employeeScheduleQueryForm.setEndDate("2020-07-14");
...
//        appointmentBaseForm.setOrgId(21);
        ...
        Map<String, Object> stringObjectMap = appointmentBiz.checkConflictTest(appointmentBaseForm);
        return ResponseUtil.success(stringObjectMap);
    }
