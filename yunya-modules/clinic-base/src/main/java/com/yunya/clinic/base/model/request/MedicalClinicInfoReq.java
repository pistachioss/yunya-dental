package com.yunya.clinic.base.model.request;
...
public class MedicalClinicInfoReq implements Serializable {
  /** 组织统一信用代码 */
  ...
  /** 营业开始时间 */
  @ApiModelProperty(value = "营业开始时间", example = "08:01")
  private String businessStartTime;
  /** 营业结束时间 */
  @ApiModelProperty(value = "businessEndTime", example = "23:01")
