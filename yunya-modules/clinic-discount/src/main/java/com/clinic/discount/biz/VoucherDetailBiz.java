...
import com.clinic.discount.entity.VoucherDetail;
import com.clinic.discount.form.DiscountDetailForm;
import com.clinic.discount.form.DiscountDetailNode;
import com.clinic.discount.mapper.VoucherDetailMapper;
...
public class VoucherDetailBiz extends BaseBiz<VoucherDetailMapper, VoucherDetail> {
    ...
    public void updateVoucherDetail(DiscountDetailForm discountDetailForm) {
        ...
        if (!cardClinicBiz.selectList(cardClinic).isEmpty()) {
            throw new BaseException("卡券已完成分配，无法修改代金券项目", CARD_EXIST);
        }
