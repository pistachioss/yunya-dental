...
public class AppointmentBiz extends BaseBiz<AppointmentMapper, Appointment> {
    ...
    private WxTemplateMsgModel generateModel(AppointmentBaseModel appoint) {
        ...
        paramMap.put(TemplateDataEnum.PATIENT_NAME.getArgName(), appoint.getPatientName());
    ...
    private WxTemplateMsgModel cancelPush(Appointment appointment) {
        ...
        paramMap.put(TemplateDataEnum.LINK_MOBILE.getArgName(), org.getTel());
        paramMap.put(TemplateDataEnum.APPOINT_DATE.getArgName(), LocalDate.fromDateFields(appointment.getAppointDate()).toString("yyyy年MM月dd日") + " " + appointment.getAppointTime());
        paramMap.put(TemplateDataEnum.PATIENT_NAME.getArgName(), patient.getName());
