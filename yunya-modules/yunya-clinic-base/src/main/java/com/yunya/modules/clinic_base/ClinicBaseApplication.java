package com.yunya.modules.clinic_base;
...
@MapperScan("com.yunya.modules.clinic_base.mapper")
@EnableYunyaFeignClients
@EnableDiscoveryClient
@EnableCustomSwagger2
@ComponentScan(basePackages = {"com.yunya.modules.clinic_base", "com.yunya.framework"})
