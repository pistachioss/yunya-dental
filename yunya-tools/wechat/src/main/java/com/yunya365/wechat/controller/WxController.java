...
public class WxController {
    ...
    public void msgChat(@PathVariable(value = "openId") String openId) throws Exception {
        wxService.getUserInfo(openId);
    }

    @PostMapping(value = "/msg/{tempId}")
    public void pushMsg(@PathVariable(value = "tempId") String tempId) throws Exception {
    }
