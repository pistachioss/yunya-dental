...
public class ThreadPoolManager {
     ...
     * 线程名称
     */
    private static final String NAME_PREFIX = "yunya-mini-thread-";
    /**
     * 线程尾部id
     */
    ...
    public ScheduledThreadPoolExecutor scheduleExecutorService() {
        ScheduledThreadPoolExecutor scheduledThreadPoolExecutor = new ScheduledThreadPoolExecutor(CORE_POOL_SIZE, customizeThreadFactory(NAME_PREFIX));
        scheduledThreadPoolExecutor.setKeepAliveTime(KEEP_ALIVE,TimeUnit.SECONDS);
        scheduledThreadPoolExecutor.setMaximumPoolSize(MAXIMUM_POOL_SIZE);
        scheduledThreadPoolExecutor.setRejectedExecutionHandler(customizeRejectHandler());
