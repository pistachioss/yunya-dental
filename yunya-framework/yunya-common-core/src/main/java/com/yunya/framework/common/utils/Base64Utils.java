...
public class Base64Utils {
    ...
    public static byte[] decoderImage(String imgData) {
        ...
        byte[] b = new byte[0];
        try {
            b = decoder.decodeBuffer(imgData);
        } catch (IOException e) {
            e.printStackTrace();
        }
