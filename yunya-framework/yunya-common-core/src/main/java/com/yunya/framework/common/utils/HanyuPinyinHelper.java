/**
 * Copyright (C), 2015-2019, 上海云牙医疗信息科技有限公司 FileName: aaa Author: yzg Date: 5/16/2019 3:46 PM
 * Description: aaa History: <author> <time> <version> <desc> 作者姓名 修改时间 版本号 描述
 */
...
public class HanyuPinyinHelper {
    ...
    try {
      for (char clChar : cl_chars) {
        ...
        if (str.matches("[\u4e00-\u9fa5]+")) {
          ...
          hanyupinyin.append(
              PinyinHelper.toHanyuPinyinStringArray(clChar, defaultFormat)[0].substring(0, 1));
  ...
  /**
   * 取第一个汉字的第一个字符 @Title: getFirstLetter @Description: TODO
   *
   * @return String
   * @throws
   */
