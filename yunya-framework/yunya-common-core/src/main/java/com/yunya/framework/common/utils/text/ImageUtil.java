...
public class ImageUtil {
  ...
  public static BufferedImage resizeImage(
      final BufferedImage bufferedImage, final int width, final int height) {
    int type = bufferedImage.getColorModel().getTransparency();
    BufferedImage image = new BufferedImage(width, height, type);
   ...
   * @throws java.io.IOException IO异常。
   */
  public static byte[] imageToByte(final BufferedImage bufferedImage, final String formatName)
      throws IOException {
  ...
  public static void writeImage(
      final BufferedImage bufferedImage, final OutputStream output, final String formatName)
      throws IOException {
    ImageIO.write(bufferedImage, formatName, output);
  }
   ...
   */
  public static void writeImage(
      final byte[] imageBytes, final OutputStream output, final String formatName)
      throws IOException {
    BufferedImage image = byteToImage(imageBytes);
