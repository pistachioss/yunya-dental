package com.yunya.framework.redis.aspect;

import com.yunya.framework.redis.annotation.RedisCache;
import com.yunya.framework.redis.annotation.RedisEvict;
...
public class RedisAspect {
  ...
  /** 定义切入点，使用了 @RedisCache 注解的方法 */
  @Pointcut("@annotation(com.yunya.framework.redis.annotation.RedisCache)")
  public void redisCachePoint() {}

  /** 定义切入点，使用了 @RedisEvict 注解的方法 */
  @Pointcut("@annotation(com.yunya.framework.redis.annotation.RedisEvict)")
