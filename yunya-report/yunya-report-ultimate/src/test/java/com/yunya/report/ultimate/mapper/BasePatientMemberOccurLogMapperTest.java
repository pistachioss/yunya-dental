...
public class BasePatientMemberOccurLogMapperTest {
    ...
    @Test
    public void find() {
        StatementPatientCardRechargeDetailInfoQuery query = new StatementPatientCardRechargeDetailInfoQuery();
        query.setOrgId(35);
        ...
        List<StatementPatientCardRechargeDetailVO> vos = patientMemberOccurLogMapper.selectPatientCardRechargeDetailList(query);
