 ...
 * @description: 患者来源推荐关系中间表同步-控制层
 * @since: 1.0.0
 */

@RestController
@RequestMapping("patientOriginLog")
public class BasePatientOriginLogController {
  /** 注入服务 */
  @Resource
  private BasePatientOriginLogBiz basePatientOriginLogBiz;
