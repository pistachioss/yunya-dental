...
public class ReceiverMessageController {
    ...
    @Autowired
    private BaseBenefitServiceImpl baseBenefitService;

    @RabbitHandler
    public void handleMiddleSingle(MessageModel messageModel, Channel channel, Message message) throws Exception {
        // 处理消息
