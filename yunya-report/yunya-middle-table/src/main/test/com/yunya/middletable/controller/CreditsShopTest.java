...
import com.yunya.middletable.task.AutoUpdateCheckedOrder;
...
public class CreditsShopTest {
  ...
  @Autowired private AutoUpdateCheckedOrder autoUpdateCheckedOrder;
  ...
  public void duibaAutoLoginControllerTest() {
    ResponseResult<Map<String, String>> url =
        shopController.duibaAutoLogin("oZRpos5NDKSkcLc9kQs38acsEBLI", "10086");
  ...
  @Test
  public void updOrder() throws InterruptedException {
    autoUpdateCheckedOrder.autoUpdateOrderAndTreatment();
  }
}
