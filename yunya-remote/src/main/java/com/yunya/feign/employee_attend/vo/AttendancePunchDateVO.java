...
public class AttendancePunchDateVO implements Serializable {
    ...
    /** 请假情况：0-无，1-仅上午请假，2-仅下午请假，3-全天请假（同一请假），4-当天两个不同的请假，5-按天请假*/
    @ApiModelProperty(value = "请假情况：0-无，1-仅上午请假，2-仅下午请假，3-全天请假（同一请假），4-当天两个不同的请假，5-按天请假")
    private Byte leave;

    /** 加班情况：0-无，1-仅上午加班，2-仅下午加班，3-全天加班（同一加班），4-当天两个不同的加班 */
    @ApiModelProperty(value = "加班情况：0-无，1-仅上午加班，2-仅下午加班，3-全天加班（同一加班），4-当天两个不同的加班")
    private Byte workOvertime;

    /** 外勤情况：0-无，1-仅上午外勤，2-仅下午外勤，3-全天外勤（同一外勤），4-当天两个不同的外勤*/
    @ApiModelProperty(value = "外勤情况：0-无，1-仅上午外勤，2-仅下午外勤，3-全天外勤（同一外勤），4-当天两个不同的外勤")
    private Byte field;
