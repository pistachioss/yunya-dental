...
public class AssistantMatchingStatisticsVO implements Serializable {
  ...
  /** 助手1配诊时长 */
  @Excel(name = "助手1配诊时长（分钟）", cellType = Excel.ColumnType.NUMERIC, isStatistics = true)
  @ApiModelProperty("助手1配诊时长")
  private Integer treatMatchingTimeAsAssistant1;
  /** 助手1配诊实收工作量 */
  @Excel(name = "助手1配诊实收工作量", scale = 2, cellType = Excel.ColumnType.NUMERIC, isStatistics = true)
  @ApiModelProperty("助手1配诊实收工作量")
  private BigDecimal treatMatchingActualWorkloadAsAssistant1;
  /** 助手1配诊退费工作量 */
  @Excel(name = "助手1配诊退费金额", scale = 2, cellType = Excel.ColumnType.NUMERIC, isStatistics = true)
  @ApiModelProperty("助手1配诊退费工作量")
  private BigDecimal treatMatchingRefundWorkloadAsAssistant1;
  /** 助手2配诊时长 */
  @Excel(name = "助手2配诊时长（分钟）", cellType = Excel.ColumnType.NUMERIC, isStatistics = true)
  @ApiModelProperty("助手2配诊时长")
  private Integer treatMatchingTimeAsAssistant2;
  /** 助手2配诊实收工作量 */
  @Excel(name = "助手2配诊实收工作量", scale = 2, cellType = Excel.ColumnType.NUMERIC, isStatistics = true)
  @ApiModelProperty("助手2配诊实收工作量")
  private BigDecimal treatMatchingActualWorkloadAsAssistant2;
  /** 助手2配诊退费工作量 */
  @Excel(name = "助手2配诊退费金额", scale = 2, cellType = Excel.ColumnType.NUMERIC, isStatistics = true)
  @ApiModelProperty("助手2配诊退费工作量")
  private BigDecimal treatMatchingRefundWorkloadAsAssistant2;
  /** 巡回配诊时长 */
  @Excel(name = "巡回配诊时长（分钟）", cellType = Excel.ColumnType.NUMERIC, isStatistics = true)
  @ApiModelProperty("巡回配诊时长")
  private Integer treatMatchingTimeAsAssistant3;
  /** 巡回配诊实收工作量 */
  @Excel(name = "巡回配诊实收工作量", scale = 2, cellType = Excel.ColumnType.NUMERIC, isStatistics = true)
  @ApiModelProperty("巡回配诊实收工作量")
  private BigDecimal treatMatchingActualWorkloadAsAssistant3;
  /** 巡回配诊退费工作量 */
  @Excel(name = "巡回配诊退费金额", scale = 2, cellType = Excel.ColumnType.NUMERIC, isStatistics = true)
