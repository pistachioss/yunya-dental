...
public class EmployeeDiagnosisInfoVO implements Serializable {
  ...
  /** 排班时长(分钟） */
  @Excel(name = "排班时长(分钟）", cellType = Excel.ColumnType.NUMERIC)
  @ApiModelProperty("排班时长")
  private Integer totalShiftTime;
  /** 治疗时长（分钟） */
  @Excel(name = "治疗时长（分钟）", cellType = Excel.ColumnType.NUMERIC)
  ...
  /** 人均消费 */
  @Excel(name = "人均消费", cellType = Excel.ColumnType.NUMERIC)
  ...
  /** 到诊人次 */
  @Excel(name = "到诊人次", cellType = Excel.ColumnType.NUMERIC)
