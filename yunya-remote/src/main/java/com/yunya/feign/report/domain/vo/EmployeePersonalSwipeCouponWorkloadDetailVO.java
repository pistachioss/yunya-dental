 ...
 * @since: 1.0.0
 */
@ApiModel("员工划扣补入工作量明细VO")
@Data
@ToString
public class EmployeePersonalSwipeCouponWorkloadDetailVO implements Serializable {
  /** 账单ID */
  ...
  /** 划扣补入工作量 */
  @Excel(name = "划扣补入工作量", cellType = NUMERIC, type = EXPORT, isStatistics = true)
