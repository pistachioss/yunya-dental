 ...
 * @since: 1.0.0
 */
@ApiModel("助手配诊退费明细查询参数")
@Data
@ToString
@EqualsAndHashCode(callSuper = true)
public class AssistantRefundDetailQuery extends PageQuery implements Serializable {
  /** 门诊ID */
  ...
  /** 开单开始日期 */
  @ApiModelProperty(value = "退费开始日期", example = "yyyy-MM-dd")
  private String refundStartDate;
  /** 开单结束日期 */
  @ApiModelProperty(value = "退费结束日期", example = "yyyy-MM-dd")
