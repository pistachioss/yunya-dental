...
public class TreatmentRecordReportVO implements Serializable {
  ...
  /** 预约时长 */
  @Excel(name = "预约时长(分钟)", cellType = NUMERIC)
  ...
  /** 挂号看诊等待时长 */
  @Excel(name = "挂号看诊等待时长(分钟)", cellType = NUMERIC, type = EXPORT, isStatistics = true)
  @ApiModelProperty("挂号看诊等待时长")
  private Integer treatWaitingTime;
  /** 看诊时长 */
  @Excel(name = "看诊时长(分钟)", cellType = NUMERIC, type = EXPORT, isStatistics = true)
