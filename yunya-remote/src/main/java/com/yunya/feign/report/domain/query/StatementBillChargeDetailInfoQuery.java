 ...
 * @since: 1.0.0
 */
@ApiModel("对账单账单收费明细信息查询参数封装")
@Data
@ToString
@EqualsAndHashCode(callSuper = true)
public class StatementBillChargeDetailInfoQuery extends PageQuery implements Serializable {
  /** 组织ID */
  ...
  /** 收费开始日期 */
  @ApiModelProperty("收费（收欠费）开始日期")
  private String chargeStartDate;
  /** 收费结束日期 */
  @ApiModelProperty("收费（收欠费）结束日期")
