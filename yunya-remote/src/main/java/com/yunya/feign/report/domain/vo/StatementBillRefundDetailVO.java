...
public class StatementBillRefundDetailVO implements Serializable {
  ...
  /** 会员卡本金 */
  @Excel(name = "会员卡本金", scale = 2, cellType = Excel.ColumnType.NUMERIC, isStatistics = true)
  @ApiModelProperty("会员卡本金")
  private BigDecimal memberPrincipleAmount;
  /** 会员卡赠金 */
  @Excel(name = "会员卡赠金", scale = 2, cellType = Excel.ColumnType.NUMERIC, isStatistics = true)
  @ApiModelProperty("会员卡赠金")
  private BigDecimal memberBonusAmount;
  /** 预付款本金 */
  @Excel(name = "预付款本金", scale = 2, cellType = Excel.ColumnType.NUMERIC, isStatistics = true)
  @ApiModelProperty("预付款本金")
  private BigDecimal prepaidPrincipleAmount;
  /** 预付款赠金 */
  @Excel(name = "预付款赠金", scale = 2, cellType = Excel.ColumnType.NUMERIC, isStatistics = true)
