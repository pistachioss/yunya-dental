...
public class BasePrepaidExpendLogVo {
  ...
  /** 本次消费本金 */
  @Excel(name = "本次消费本金", cellType = NUMERIC, isStatistics = true, type = EXPORT)
  @ApiModelProperty("本次消费本金")
  private BigDecimal principalAmount = new BigDecimal(0);

  /** 本次消费赠金 */
  @Excel(name = "本次消费赠金", cellType = NUMERIC, isStatistics = true, type = EXPORT)
  @ApiModelProperty("本次消费赠金")
  private BigDecimal bonusAmount = new BigDecimal(0);

  /** 消费后预付款余额（含赠送金额） */
  @Excel(name = "消费后预付款余额（含赠送金额）", cellType = NUMERIC, isStatistics = true, type = EXPORT)
