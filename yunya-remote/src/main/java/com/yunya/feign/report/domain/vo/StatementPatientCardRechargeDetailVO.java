...
public class StatementPatientCardRechargeDetailVO implements Serializable {
  ...
  /** 充值本金金额 */
  @Excel(name = "充值本金金额", scale = 2, cellType = Excel.ColumnType.NUMERIC, isStatistics = true)
  @ApiModelProperty("充值本金金额")
  private BigDecimal rechargePrincipleAmount;
  /** 充值赠金金额 */
  @Excel(name = "充值赠送金额", scale = 2, cellType = Excel.ColumnType.NUMERIC, isStatistics = true)
