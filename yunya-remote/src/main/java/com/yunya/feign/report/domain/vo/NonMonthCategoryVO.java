...
public class NonMonthCategoryVO implements Serializable {
  ...
  /** 开单金额 */
  @Excel(name = "开单金额", cellType = NUMERIC, type = EXPORT, isStatistics = true)
  ...
  /** 项目大类金额 */
  @Excel(name = "项目大类金额", cellType = NUMERIC, type = EXPORT, isStatistics = true)
  @ApiModelProperty("项目大类金额")
  private BigDecimal actualAmount = BigDecimal.ZERO;
  /** 非当月免单金额 */
  @Excel(name = "非当月免单金额", cellType = NUMERIC, type = EXPORT, isStatistics = true)
  ...
  /** 非当月免单金额分摊 */
  @Excel(name = "非当月免单金额分摊", cellType = NUMERIC, type = EXPORT, isStatistics = true)
  @ApiModelProperty("非当月免单金额分摊")
  private BigDecimal freeAmount = BigDecimal.ZERO;
  /** 非本月账单项目补入工作量 */
  @Excel(name = "非本月账单项目补入工作量", cellType = NUMERIC, type = EXPORT, isStatistics = true)
